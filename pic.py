...
search_query = '轮胎'  # 检索的关键词，可自行更改
location_driver = 'C:/Users/XiaoXuHan/Downloads/chromedriver_win32/chromedriver.exe'  # Chrome驱动程序在电脑中的位置
...
class Crawler:
    ...
    def start_brower(self):
        ...
        # 启动Chrome浏览器
        driver = webdriver.Chrome(executable_path=location_driver,
    ...
    def downloadImg(self, driver):
        ...
        for i in range(100):  # 此处可自己设置爬取范围，本处设置为1，那么不会有下滑出现
            ...
            imglist = soup.findAll('img',
                                   {'src': re.compile(r'https:.*\.(jpg|png)')})
